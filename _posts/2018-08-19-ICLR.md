...
Naturally, we would like to have some theoretical guarantees on the convergence
...
situations covered. Well, it turns out that **Adam does not pass this sanity
test (and that the original convergence proof is flawed)**, as stated by this
